<html lang="en">
  ...
  <?php if (file_exists(ROOT_DIR . '/app/views/partials/header.php')) { $title = "Home"; require_once ROOT_DIR . '/app/views/partials/header.php'; } ?>
    ...
    <form id="signup" name="signup" action="<?php echo SITE_HOST; ?>/auth/signup" method="POST">
      <div class="container">
        ...
        <div id="oauth">
          <a href="<?php echo SITE_HOST; ?>/auth/slack/signup"><button id="slack" style="font-family: 'Architects Daughter', cursive;" type="button">Slack</button></a>
          <a href="<?php echo SITE_HOST; ?>/auth/google/signup"><button id="google" style="font-family: 'Architects Daughter', cursive;" type="button">Google+</button></a>
          <a href="<?php echo SITE_HOST; ?>/auth/fourtytwo/signup"><button id="fourty" style="font-family: 'Architects Daughter', cursive;" type="button">42</button></a>
          <a href="<?php echo SITE_HOST; ?>/auth/github/signup"><button id="github" style="font-family: 'Architects Daughter', cursive; color: black;" type="button">Github</button></a>
        </div>
      </div>
    </form>
