<html lang="en">
  ...
  <body style="background-image: url('<?php 
    ...
    <header>
      ...
      <ul class="topnav" id="myTopnav">
        ...
        <?php 
          ...
          if (isset($_SESSION['user'])) { 
            echo '<li><a href="/Camagru/public/profile/home">Profile</a></li>'; 
          } 
          else { 
            echo '<li><a href="/Camagru/public/auth/signup">Create Account</a></li>'; 
          } 
        ?>
    ...
    <?php
      if (file_exists('../app/views/flash/flash.php')) { 
        require_once '../app/views/flash/flash.php'; 
      } 
      else { 
